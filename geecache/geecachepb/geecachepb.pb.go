...
type Request struct {
	...
	Group         string                 `protobuf:"bytes,1,opt,name=group,proto3" json:"group,omitempty"` //这个1是字段编号，标识字段是谁
...
const file_geecachepb_proto_rawDesc = "" +
	...
	"\n" +
	"GroupCache\x120\n" +
	"\x03Get\x12\x13.geecachepb.Request\x1a\x14.geecachepb.ResponseB!Z\x1fGopherStore/geecache/geecachepbb\x06proto3"
